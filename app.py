...
schedule.every(12).hours.do(open_bet_garbage_collector)
...
def take_bet(odd_id):
    ...
    print(BetSelectedOption.query.filter_by(bet_coupon_fk=current_coupon.id).filter_by(
            match_name=bet_odd.bet_option.match_name).all())
